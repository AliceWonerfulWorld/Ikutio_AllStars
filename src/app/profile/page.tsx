...
export default function ProfilePage() {
  ...
  const mockPosts = [
    ...
    {
      id: 3,
      content: 'React 19の新機能について調べています。',
      timestamp: '3日前',
      likes: 15,
      replies: 5,
      ...
      <div className="flex max-w-7xl mx-auto">
        ...
        <div className="flex-1 min-w-0 max-w-2xl border-r border-gray-800">
          ...
          <div className="relative">
            ...
            <div className="px-4 pb-4">
              <div className="flex justify-between items-end -mt-16">
                <div className="relative">
                  <div className="w-32 h-32 bg-gradient-to-r from-green-500 to-blue-500 rounded-full border-4 border-black flex items-center justify-center text-white text-4xl font-bold">
          ...
          <div className="flex border-b border-gray-800">
            <button className="px-6 py-4 text-sm font-medium text-white border-b-2 border-blue-500">
              投稿
            </button>
            <button className="px-6 py-4 text-sm font-medium text-gray-500 hover:text-white">
              返信
            </button>
            <button className="px-6 py-4 text-sm font-medium text-gray-500 hover:text-white">
              メディア
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-semibold">tech_guru</div>
                    <div className="text-sm text-gray-400">@tech_guru</div>
                  </div>
                </div>
                <button className="bg-white text-black px-4 py-1 rounded-full text-sm font-semibold hover:bg-gray-200 transition-colors">
                  フォロー
          ...
          <div className="bg-gray-800 rounded-2xl p-4">
            ...
            <div className="space-y-3">
              <div className="hover:bg-gray-700 p-2 rounded-lg cursor-pointer transition-colors">
                <div className="text-sm text-gray-400">プログラミング</div>
                <div className="font-semibold">#Next.js</div>
                <div className="text-sm text-gray-400">12.3K件のツイート</div>
              </div>
              <div className="hover:bg-gray-700 p-2 rounded-lg cursor-pointer transition-colors">
                <div className="text-sm text-gray-400">テクノロジー</div>
                <div className="font-semibold">#Supabase</div>
                <div className="text-sm text-gray-400">8.7K件のツイート</div>
              </div>
            </div>
          </div>
        </div>
