...
export const mockPosts: Post[] = [
  {
    ...
    title: "今日は天気が良くて気分がいいです！散歩に出かけようと思います。",
    likes: 24,
    tags: ["天気", "散歩"],
    user_id: "user1",
    username: "user1",
  ...
  },
  {
    ...
    title:
      "新しいプロジェクトを始めました。Next.jsとSupabaseを使ってSNSアプリを作成中です。",
    likes: 156,
  ...
  },
  {
    ...
    title: "コーヒーを飲みながらコードを書いています。集中力が高まります。",
    likes: 8,
    tags: ["コーヒー", "プログラミング"],
    user_id: "user3",
    username: "user3",
  ...
  },
  {
    ...
    title:
      "今日学んだこと：ReactのuseEffectの依存配列について。空の配列を渡すと初回レンダリング時のみ実行される。",
    likes: 42,
